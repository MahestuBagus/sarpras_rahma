            ...
            <div class="flex justify-center items-center flex-wrap h-full g-6 text-gray-600">
                <div id="carouselExampleControls" class="carousel slide relative" data-bs-ride="carousel">
                    <div class="carousel-inner relative w-full overflow-hidden">
                        <div class="carousel-item active relative float-left w-12/12">
                ...
                <div class="md:w- lg:w-5/12 lg:ml-10 w">
                    <form>
                        <!-- NISN input -->
                        <!-- <div class="mb-6">
                        ...
                        <div class="text-xl my-4 font-semibold text-white">
                            <span>Silahkan Login </span> <br>
                        ...
                        <!-- Submit button -->
                        <button type="submit" class="inline-block px-7 py-3 bg-yellow-500 text-white font-semibold text-sm leading-snug uppercase rounded shadow-md hover:bg-yellow-600 hover:shadow-lg focus:bg-yellow-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-yellow-600     active:shadow-lg transition duration-150 ease-in-out w-full" data-mdb-ripple="true" data-mdb-ripple-color="light">
                            Login
                        </button>
